...
//0521:16135 0522:16490 0523:16942 0524:17428 0525:17177


var selectID;
var jsonOutside;
var active;
var unassigned =  16908;/////
...
d3.select("#datainfor").html("Data updated time: 2020-05-26 (Dataset from CSSEGISandData)");
...
d3.csv("../data/total_ad.csv", function(data_total_ad) {
  d3.json("../data/states.json", function(states_json) {
    d3.csv("../data/Data_0526.csv", function(data_cases) {
