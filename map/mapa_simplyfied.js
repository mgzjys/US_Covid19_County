...
//0514:12756 0515:13137 0516:13964 0517:14550 0518:15801


var selectID;
var jsonOutside;
var active;
var unassigned =  15919;/////
...
d3.select("#datainfor").html("Data updated time: 2020-05-20 (Dataset from CSSEGISandData)");
...
d3.csv("../data/total_ad.csv", function(data_total_ad) {
  d3.json("../data/states.json", function(states_json) {
    d3.csv("../data/Data_0519.csv", function(data_cases) {
