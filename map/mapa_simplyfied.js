...
// 0416: 13073 0417:12931 0419:13059 0420:19042


var selectID;
var jsonOutside;
var active;
var unassigned =  19808;/////
...
d3.select("#datainfor").html("Data updated time: 2020-04-21 14:00 EST");
...
d3.csv("../data/total_ad.csv", function(data_total_ad) {
  d3.json("../data/states.json", function(states_json) {
    d3.csv("../data/Data_0421.csv", function(data_cases) {
