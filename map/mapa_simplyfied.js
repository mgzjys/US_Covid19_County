...
//0403:8200 0404:7368 0405:7321 0406:7537 0407:6371
...
d3.select("#datainfor").html("Data updated time: 2020-04-08 14:00 EST");
...
d3.csv("../data/total_ad.csv", function(data_total_ad) {
  d3.json("../data/states.json", function(states_json) {
    d3.csv("../data/Data_0408.csv", function(data_cases) {
