...
//0604:21029 0605:21597 0606:22295 0607:28734 0608:27935 0609:22514


var selectID;
var jsonOutside;
var active;
var unassigned =  22691;/////
...
d3.select("#datainfor").html("Data updated time: 2020-06-11 (Dataset from CSSEGISandData)");
...
d3.csv("../data/total_ad.csv", function(data_total_ad) {
  d3.json("../data/states.json", function(states_json) {
    d3.csv("../data/Data_0610.csv", function(data_cases) {
