...
//0521:16135 0522:16490 0523:16942

var selectID;
var jsonOutside;
var active;
var unassigned =  17428;/////
...
d3.select("#datainfor").html("Data updated time: 2020-05-25 (Dataset from CSSEGISandData)");
...
d3.csv("../data/total_ad.csv", function(data_total_ad) {
  d3.json("../data/states.json", function(states_json) {
    d3.csv("../data/Data_0524.csv", function(data_cases) {
