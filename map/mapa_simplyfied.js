...
//0514:12756 0515:13137 0516:13964


var selectID;
var jsonOutside;
var active;
var unassigned =  14550;/////
...
d3.select("#datainfor").html("Data updated time: 2020-05-18 (Dataset from CSSEGISandData)");
...
d3.csv("../data/total_ad.csv", function(data_total_ad) {
  d3.json("../data/states.json", function(states_json) {
    d3.csv("../data/Data_0517.csv", function(data_cases) {
