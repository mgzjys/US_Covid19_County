...
//0403:8200 0404:7368 0405:7321 0406:7537

var selectID;
var jsonOutside;
var active;
var unassigned = 14614;/////
...
d3.select("#datainfor").html("Data updated time: 2020-04-07 14:00 EST");
...
d3.csv("../data/total_ad.csv", function(data_total_ad) {
  d3.json("../data/states.json", function(states_json) {
    d3.csv("../data/Data_0407.csv", function(data_cases) {
