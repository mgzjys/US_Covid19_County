 ...
 */
d3 = d3versionV3;
//0321:735 0322: 604 0323: 1356  0324: 1927 0325:1927 0326：2903  0327:3711 0328:4549 0329:5361 0330:6644


var jsonOutside;
var active;
var unassigned = 12207;/////
...
d3.select("#datainfor").html("Data updated time: 2020-03-31 16:00 EST");
...
d3.csv("../data/total_ad.csv", function(data_total_ad) {
  d3.json("../data/states.json", function(states_json) {
    d3.csv("../data/Data_0331.csv", function(data_cases) {
