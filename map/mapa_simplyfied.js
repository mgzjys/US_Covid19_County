...
//0403:8200 0404:7368 0405:7321 0406:7537 0407:6371 0408:9623
...
d3.select("#datainfor").html("Data updated time: 2020-04-09 09:00 EST");
...
d3.csv("../data/total_ad.csv", function(data_total_ad) {
  d3.json("../data/states.json", function(states_json) {
    d3.csv("../data/Data_0409.csv", function(data_cases) {
