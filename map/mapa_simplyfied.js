...
//0507:11831 0508:12163

var selectID;
var jsonOutside;
var active;
var unassigned =  12278;/////
...
d3.select("#datainfor").html("Data updated time: 2020-05-10 (Dataset from CSSEGISandData)");
...
d3.csv("../data/total_ad.csv", function(data_total_ad) {
  d3.json("../data/states.json", function(states_json) {
    d3.csv("../data/Data_0509.csv", function(data_cases) {
