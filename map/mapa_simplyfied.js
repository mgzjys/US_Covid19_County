...
//0430:9520 0501:10132 0502:10773 0503:11451


var selectID;
var jsonOutside;
var active;
var unassigned =  11366;/////
...
d3.select("#datainfor").html("Data updated time: 2020-05-05 (Dataset from CSSEGISandData)");
...
d3.csv("../data/total_ad.csv", function(data_total_ad) {
  d3.json("../data/states.json", function(states_json) {
    d3.csv("../data/Data_0504.csv", function(data_cases) {
